...
function ExchangeMiddleTop({
  ...
  return (
    <div className="exchangemiddletop">
      <div></div>
      <div className="viscle_mobile_currency_info_box">
        ...
        <div className="viscle_mobile_Currency__Info__Box">
          <div className="viscle_mobile_currencyUpdate">
            <p className="viscle_mobile_Currency__Info__Box_header">{timeInfo} Change</p>
            <div className="viscle_mobile_exchangemiddletop_chenging_percent">
              <div>
                <span>
                  {topRate && (
